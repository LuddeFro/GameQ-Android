...
public class DeviceListFragment extends ListFragment {
	...
	public void onResume() {
		...
		t.scheduleAtFixedRate(
		    ...
		    6000,      // run first occurrence immediately
		    6000);  // run every three seconds
		/*
	...
	public class PostTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			((SwipeActivity) getActivity()).initiation();
			String listString = ((SwipeActivity) getActivity()).connectionsHandler.postUpdateDraw(mEmail);
