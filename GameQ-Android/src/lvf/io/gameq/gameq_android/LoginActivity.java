	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new AsyncTask<Void, Void, String>() {
	        ...
	        protected String doInBackground(Void... params) {
	            String msg = "";
	            msg = connectionsHandler.postVersion();
	            return msg;
	        }
	        ...
	        protected void onPostExecute(String msg) {
	        	if (msg.equals("0")) {
	        		alert(getResources().getString(R.string.newVersion));
	        	}
	        }
	    }.execute(null, null, null);	
	    String virgin = getFirstLogger();
	    if (virgin == null) {
	    	alert(getResources().getString(R.string.EULA));
	    	setFirstLogger("banana");
	    } else if (!virgin.equals("banana")) {
	    	alert(getResources().getString(R.string.EULA));
	    	setFirstLogger("banana");
    	}
		isRegging = false;
